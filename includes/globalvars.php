...
define('SERVER_NAME','Israel Gunz');
define('SERVER_ID',1);
define('SITE_TITLE','IsraelGunZ');
define('SITE_URL','http://localhost/PHP%20Projects/ActivityWebsite/');
define('SITE_ROOT',$_SERVER['DOCUMENT_ROOT'].'PHP Projects/ActivityWebsite/');

/*
//CronJobs
*/
define('CRON_LOGS_DIR', 'C:/wamp/www/PHP Projects/ActivityWebsite/public/cronJobs/logs/');
define('LOG_SPACE', '	');
...
'home' => array('html' => array('home'),'php' =>array('home'))
);
...
*/
$User_Allowed_Fields = array('UserID','AID','UGradeID','Name','Email','Age','RegDate',$DataBase_Fields['Coins'],'SQ','SA');
